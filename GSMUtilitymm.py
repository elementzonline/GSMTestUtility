...
# Form implementation generated from reading ui file '/home/pheonix/Dropbox/MY_DOC/Python_Projects/GSM_Test_Utility/GSMUtility.ui'
#
# Created: Fri May 13 14:01:17 2016
...
"QPlainTextEdit {border:4px outset; border-radius: 0px; border-color: blue; color:black;  background-color: rgb(235, 235, 235);; padding:5px;font: 75 12pt \"MS Shell Dlg 2\";}"))
        ...
        self.disconnectButton = QtGui.QPushButton(self.settingsTab)
        ...
        self.disconnectButton.setMinimumSize(QtCore.QSize(200, 50))
        self.disconnectButton.setMaximumSize(QtCore.QSize(200, 50))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/disconnect.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.disconnectButton.setIcon(icon)
        self.disconnectButton.setIconSize(QtCore.QSize(32, 32))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/find.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton = QtGui.QPushButton(self.scriptTab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit = QtGui.QLineEdit(self.scriptTab)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/New.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew.setIcon(icon4)
        self.actionNew.setObjectName(_fromUtf8("actionNew"))
        self.actionOpen = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/open.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setToolTip(_translate("MainWindow", "Type AT command and press Send Button, eg: AT+CSQ", None))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Eg: AT+CSQ", None))
        ...
        self.plainTextEdit_2.setToolTip(_translate("MainWindow", "Serial Console is readonly!!", None))
        self.plainTextEdit_2.setPlainText(_translate("MainWindow", "Serial Console", None))
